 ...
 */
class CRM_Financialsummaries_Form_Search_contribswithpricesets extends CRM_Contact_Form_Search_Custom_Base implements CRM_Contact_Form_Search_Interface {
  ...
  function buildForm(&$form) {
    CRM_Utils_System::setTitle(ts('Contributions with Pricesets'));
